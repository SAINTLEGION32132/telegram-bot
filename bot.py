...
def get_info_text() -> str:
    return (
        f"— 💻 <b>Информация по боту</b>\n\n"
        f"✅ <b>Доступные команды:</b>\n"
        f"<blockquote>"
        f"• <code>/start</code> - Главное меню\n"
        f"• <code>/me</code> - Ваш профиль\n"
        f"• <code>/top</code> - Топ воркеров\n"
        f"• <code>/kassa</code> - Касса команды\n"
        f"• <code>/info (ID)</code> - Информация о пользователе"
        f"</blockquote>\n\n"
        f" <b>Разделы бота:</b>\n\n"
        f" • <b>Профиль - Ваша статистика и информация</b>\n"
        f" • <b>Топ воркеров - Рейтинг за все время и за день</b>\n"
        f" • <b>Касса - Общая статистика команды</b>\n\n"
